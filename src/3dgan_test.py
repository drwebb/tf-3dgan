...
def     rainGAN(is_dummy=False):
    ...
    d_loss =     f.nn.sigmoid_cross_en    ropy_wi    h_logi    s(logi    s=d_ou    pu    _x, labels=    f.ones_like(d_ou    pu    _x)) +     f.nn.sigmoid_cross_en    ropy_wi    h_logi    s(logi    s=d_ou    pu    _z, labels=    f.zeros_like(d_ou    pu    _z))
    g_loss =     f.nn.sigmoid_cross_en    ropy_wi    h_logi    s(logi    s=d_ou    pu    _z, labels=    f.ones_like(d_ou    pu    _z))
